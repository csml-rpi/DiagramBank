# DiagramBank/TMLR — Runbook (Manual Pipeline)
...
If you are only adding **new papers**, you typically do **not** need to rescrape everything.

Recommended workflow:
1) Update `tmlr.py` to fetch what you need.
2) Run `python tmlr.py` to regenerate `tmlr-papers.jsonl` (staging snapshot).
